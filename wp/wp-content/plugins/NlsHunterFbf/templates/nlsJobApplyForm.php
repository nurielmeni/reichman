...
<div class="job-apply-form-wrapper w-full hidden">
    ...
    <form class="flex flex-col flex-wrap justify-center items-center lg:flex-row">
        ...
        <img src="<?= plugins_url('NlsHunterFbf/public/images/left-chevron.svg') ?>" class="rotate-270 lg:rotate-0" width="40" alt="">
        ...
        <img src="<?= plugins_url('NlsHunterFbf/public/images/left-chevron.svg') ?>" class="rotate-270 lg:rotate-0" width="40" alt="">
        <div class="apply-rounded-container bg-light"></div>
    </form>
</div>