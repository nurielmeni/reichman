<!-- File Manager modal -->
<div id="<?= $modalId ?>" tabindex="-1" aria-hidden="true" class="nls-modal flex bg-overlay hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-full justify-center items-center">
    <div class="relative w-11/12 md:w-4/5 h-full md:h-auto drop-shadow-md">
        <!-- Modal content -->
        <div class="relative shadow bg-white">
            ...
            <header class="flex justify-between items-center p-4 bg-primary">
                ...
                <button type="button" class="modal-action text-white bg-transparent hover:bg-gray-400 rounded-full text-sm p-2 inline-flex items-center border" data-modal-toggle="<?= $modalId ?>">
            ...
            <!-- Modal body -->
            <article class="body p-6 space-y-6 max-h-[70vh] overflow-y-auto">
