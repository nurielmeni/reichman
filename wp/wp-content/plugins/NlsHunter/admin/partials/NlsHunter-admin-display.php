...
<div id="NlsHunter_settings" class="wrap">
    ...
    <form method="POST">
        ...
        <section id="hunter_page_settings">
            ...
            <p>[Shortcodes]</p>
            <?= $this->adminSelectPage(NlsHunter_Admin::NLS_SEARCH_RESULTS_PAGE_EN, $nlsSearchResultsPageEn, 'Search Results Page EN') ?>
            <small>* The page must have the slug <i>[nls_hunter_search_results]</i></small>
            <br>
            <?= $this->adminSelectPage(NlsHunter_Admin::NLS_SEARCH_RESULTS_PAGE_HE, $nlsSearchResultsPageHe, 'Search Results Page HE') ?>
            <small>* The page must have the slug <i>[nls_hunter_search_results]</i></small>
            <br>
            <hr>
            <?= $this->adminSelectPage(NlsHunter_Admin::NLS_JOB_DETAILS_PAGE_EN, $nlsJobDetailsPageEn, 'Job Details Page EN') ?>
            <small>* The page must have the slug <i>[nls_hunter_job_details]</i></small>
            <br>
            <?= $this->adminSelectPage(NlsHunter_Admin::NLS_JOB_DETAILS_PAGE_HE, $nlsJobDetailsPageHe, 'Job Details Page HE') ?>
            <small>* The page must have the slug <i>[nls_hunter_job_details]</i></small>
            <br>
        ...
        <section>
            <h2>Help Details</h2>
            <p><label>Short Code</label>nls_hunter</p>
        </section>
